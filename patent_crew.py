...
# Define our agents
def create_patent_analysis_crew(model_name="deepseek-r1:1.5b"):
    """
    ...
    task1 = Task(
        description="""
        Define a research plan for ai in healthcare patents:
    ...
    task2 = Task(
        description="""
        Using the research plan, retrieve patents related to ai healthcare technology from the last 3 years.
        ...
        Group patents by sub-technologies within ai in healthcare.
    ...
    task3 = Task(
        ...
        4. Determine emerging sub-technologies within ai in healthcare
    ...
    task4 = Task(
        description="""
        Based on the patent analysis, predict future innovations in ai in healthcare technology:
...
def run_patent_analysis(research_area="Lithium Battery", model_name="deepseek-r1:1.5b"):
    """
